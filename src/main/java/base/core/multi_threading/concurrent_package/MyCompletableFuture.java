...
public class MyCompletableFuture {
    /* InterruptedException：总体来说这是一种线程被意外中断时发生的异常，这种异常不会包含任何cause，自己本身就是异常的cause
    ...
    public static void parallelCompletableFuture() throws InterruptedException, ExecutionException {
        ...
        /* supplyAsync()的作用是把外部服务callService1()的调用移交给线程池中的某一个线程来执行，而达到不阻塞当前线程的目的
         ...
         * allOf()方法接收一个CompletableFuture型List参数，返回一个CompletableFuture<Void>对象，作为所有CompletableFuture的完成信号
